...
class PoseControllerNode:
	...
	self.pose_subscriber = rospy.Subscriber('/cmd_pose', Pose2D, self.cmd_pose_callback)
	...
	# Define goal pose from message from subscriber
	self.x_g = msg.x
	self.y_g = msg.y
	self.theta_g = msg.theta
	rospy.loginfo("This is current goal %f", self.x_g)
	# Input goal pose into controller
